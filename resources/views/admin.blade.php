            ...
            <div class="style-guide-container">
                <div class="panel">
                    <div class="panel-body">
                        <div>
                            <h4 class="heading">
                                Создание контента главной странице
                            </h4>
                            <div>
                            </div>
                        </div>
                ...
                <div class="style-guide-content">
                    ...
                    <div class="row">
                        <div class="style-guide-content-item">
                            <div class="w-form">
                                <form action="{{route('UploadMainVideo')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <h6>Изображение или видео</h6>
                                <input name="file" type="file"><br><br>
                                <h5>ИЛИ</h5>
                                <h6>Ссылка на YouTube</h6>
                                <input type="text" class="form-input w-input" name="youtube" maxlength="256" placeholder="https://www.youtube.com/watch?v=XXXXXXXX"><br>
                                <button class="button w-button">
                                    Добавить
                                </button>
                                    @error('documents')
            ...
            <div class="style-guide-container">
                ...
                <div class="style-guide-content">
                    ...
                    <div class="row">
                        <div class="style-guide-content-item">
                            <div class="w-form">
                                <form action="{{route('UploadBook')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <h6>Файл</h6>
                                <input name="file" type="file"><br><br>
                                <h6>Обложка книги</h6>
                                ...
                                <input type="text" class="form-input w-input" name="name" maxlength="256" placeholder="А.С.Пушкин 'Дуб'"><br>
                                <h6>Описание книги</h6>
                                <input type="text" class="form-input w-input" name="description" maxlength="256" placeholder="А.С.Пушкин 'Дуб'"><br>
                                <button class="button w-button">
                                    Добавить
                                </button>
                                    @error('documents')
